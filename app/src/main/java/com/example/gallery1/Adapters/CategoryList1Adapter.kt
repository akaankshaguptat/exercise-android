...
class CategoryList1Adapter(
    ...
    private val arrayList: ArrayList<CategoryList1ViewModel>
) : RecyclerView.Adapter<CategoryList1Adapter.ItemView>() {

    class ItemView(val categoryBinding: CategoryBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemView {
        ...
        val categoryBinding: CategoryBinding = DataBindingUtil.inflate(
            layoutInflater,
