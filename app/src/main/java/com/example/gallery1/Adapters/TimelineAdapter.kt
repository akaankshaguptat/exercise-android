...
class TimelineAdapter(private val context: Context, private val arrayList: ArrayList<TimelineViewModel>)
    ...
    class ItemView1(var timelineBinding: TimelineBinding):RecyclerView.ViewHolder(timelineBinding.root){
