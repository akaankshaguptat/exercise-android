...
class Repository(private val firebase: FireBaseData) {
    ...
    ) = firebase.signUp(email, password, name, activity, profileImageView)
    ...
    fun uploadCategory(title: String, imageBitmap: Bitmap, activity: Activity) =
        firebase.uploadCategoryImage(title, imageBitmap, activity)
